...
public class Entity<E extends Entity<E>> extends EntityInner<E>
{
	// -------------------------------------------- //
	// FIELDS
	// -------------------------------------------- //
	
	public Coll<?> getColl() { return (Coll<?>) this.getEntityContainer(); }
	...
	public String attach(EntityContainer<E> parent)
	{
		return parent.attach((E) this);
	}
	
	@SuppressWarnings("unchecked")
	public E detach()
	{
		EntityContainer<E> coll = this.getEntityContainer();
